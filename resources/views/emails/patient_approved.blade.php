...
<head>
    <meta charset="UTF-8">
    <title>Patient Form Approved</title>
</head>
                    ...
                    <tr>
                        <td style="padding:30px; background-color:#ffffff;">
                            <div style="color:#333;">
                                ...
                                <p>
                                    We are pleased to inform you that your health information form has been
                                    <strong style="color:#28a745;">approved</strong> by our medical staff.
                                </p>

                                <p>
                                    You can now access your student dashboard and view your complete health profile.
                                    All your medical records are securely stored and available for your review.
                                </p>

                                <div style="text-align: center; margin: 30px 0;">
                                    <a href="{{ route('student.dashboard') }}"
                                        style="display: inline-block; padding: 12px 30px; background-color: #28a745; color: #ffffff; text-decoration: none; border-radius: 5px; font-weight: bold; font-size: 16px;">
                                        View Dashboard
                                    </a>
                                </div>

                                <p>
                                    If you have any questions or concerns regarding your health information,
                                    please visit the Health and Wellness Service Unit during office hours.
                                </p>
